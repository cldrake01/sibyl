...
from sibyl.utils.models.ring.distributed import AllGather, split_by_rank
from sibyl.utils.models.ring.ring import get_world_size, get_rank, is_distributed
from sibyl.utils.models.ring.ring_flash_attention import ring_flash_attn
...
class RingRotaryEmbedding(Module):
    def __init__(
        ...
        ring: bool = False,
        striped: bool = False,
        # in striped attention with flash buckets > 1, one needs to specify the number of buckets per machine
        buckets: int = 1,
        theta=10_000,
    ):
        super().__init__()
...
class RingTransformer(Module):
    ...
    def __init__(
        ...
        *,
        ...
        # if ring attention is turned on, auto-shard across sequence dimension. this can also be turned off and done
        # manually elsewhere in the data loading
        self.auto_shard_seq = default(auto_shard_seq, ring_attn)
